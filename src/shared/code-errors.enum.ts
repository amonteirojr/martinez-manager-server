export enum CodeErrors {
  ...
  FAIL_TO_DELETE_CUSTOMER = 'FAIL_TO_DELETE_CUSTOMER',
  ...
  FAIL_TO_CREATE_INVOICE = 'FAIL_TO_CREATE_INVOICE',
  FAIL_TO_FIND_ALL_INVOICES = 'FAIL_TO_FIND_ALL_INVOICES',
  FAIL_TO_FIND_INVOICE = 'FAIL_TO_FIND_INVOICE',
  ...
  FAIL_TO_UPDATE_INVOICE = 'FAIL_TO_UPDATE_INVOICE',
  FAIL_TO_DELETE_INVOICE = 'FAIL_TO_DELETE_INVOICE',
  FAIL_TO_GET_IBGE_CITIES = 'FAIL_TO_GET_IBGE_CITIES',
}
